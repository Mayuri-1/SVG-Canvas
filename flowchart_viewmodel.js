...
(function () {
	...
	flowchart.NodeViewModel = function (nodeDataModel) {
		...
		//
		// select the processType.
		//
		this.nodeType = function(){
			return this.data.nodeType ? this.data.nodeType : '';
		};
		
		this.nodeCommonHeight = function(){
			return this.width() - 50;
		};
		
		/*
		 * function to get process type of node
		 */
		this.processType = function(){
			return this.data.processType ? this.data.processType : ''; 
		};
		
		
		/*
		 * getting appname of node
		 */
		
		this.appName = function(){
			return this.data.appName ? this.data.appName :  '';
		};
